package com.williansales.workshopmongo.config;
...
import com.williansales.workshopmongo.domain.Post;
import com.williansales.workshopmongo.domain.User;
import com.williansales.workshopmongo.dto.AuthorDTO;
import com.williansales.workshopmongo.dto.CommentDTO;
import com.williansales.workshopmongo.repository.PostRepository;
...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Post post3 = new Post(null, sdf.parse("22/03/2018"), "Aproveite a vida", "Aproveite cada momento da sua vida!", new AuthorDTO(alex));
