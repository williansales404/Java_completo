...
public class Program {
	...
	public static void main(String[] args) {
		...
		//String pach ="./out.csv"; //caminho aparte da pasta de origem do projeto
		String pach ="C:\\workspace\\out.csv"; // caminho onde o arquivo vai ser criado e escrito e seu nome e formato txt
